...
public class SortUserDataImplByRollNumberTest {
	...
	public void test() {
		...
		assertEquals(userDataTest2,sortUserDataImpl.sortUserDataByRollNumber(userDataTest));
	}
